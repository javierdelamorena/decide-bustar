...
const DATA: ProposalSection[] = [
  ...
  },
  {
    ...
    data: [
      { id: '3', title: 'Festival de Música Local', description: 'Organización de festival anual para promover artistas locales', votes: 215, date: '2023-10-10' },
      { id: '4', title: 'Museo al Aire Libre', description: 'Galería de arte urbano en el distrito histórico', votes: 76, date: '2023-10-05' },
      { id: '5', title: 'Cine de Verano', description: 'Proyecciones gratuitas en plazas públicas durante el verano', votes: 142, date: '2023-10-01' },
    ],
  },
  {
    title: 'Propuestas Ambientales',
    data: [
      { id: '6', title: 'Programa de Reciclaje', description: 'Instalación de puntos de reciclaje en cada barrio', votes: 198, date: '2023-09-28' },
      { id: '7', title: 'Reforestación Urbana', description: 'Plantación de 1000 árboles en áreas urbanas', votes: 167, date: '2023-09-25' },
    ],
  },
];
...
export const ListaPropuestasVisibles = () => {
  ...
  const renderSectionHeader = ({ section }: { section: ProposalSection }) => (
    ...
    <SafeAreaProvider>
      <SafeAreaView style={styles.container} edges={['top']}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Participa en las ideas para mejorar nuestra ciudad</Text>
        </View>
