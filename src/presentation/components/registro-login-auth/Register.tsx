...
export const Register = () => {
  ...
  const registrar = async (nombre: any, apellidos: any, email: any, direccion: any) => {
    const url = `https://localhost:8080/registro/${nombre}/${apellidos}/${email}/${direccion}`;
  ...
  const handleRegister = () => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      registrar(nombre, apellidos, email, direccion);
